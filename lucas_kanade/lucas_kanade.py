...
def lucas_kanade(firstImage, secondImage, N, image_ind, dataset, tau=1e-3):
    ...
    # cv2.imwrite(f'./results/lucas_kanade/optical_flow/{dataset}/flow_map_{image_ind}.png', added_image)
    # vis_optic_flow_arrows(firstImage, [u, v], f'./results/lucas_kanade/optical_flow/{dataset}/flow_map_{image_ind}.png')
    plt.show()
